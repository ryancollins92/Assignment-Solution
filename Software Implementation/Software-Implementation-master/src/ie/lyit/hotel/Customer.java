...
public class Customer extends Person implements Serializable {// INHERITANCE - Customer IS-A Person
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8993178546348115674L;
	...
	public Customer(Customer customer) {
		this(customer.getName().getTitle(), customer.getName().getFirstName(), customer.getName().getSurname(), customer.getAddress(), customer.getPhoneNumber(), customer.getEmailAddress());
	}
